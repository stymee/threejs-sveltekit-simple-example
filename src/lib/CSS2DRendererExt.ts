// Derived from https://threejs.org/docs/index.html?q=css2d#examples/en/renderers/CSS2DRenderer
	...
	constructor(element: HTMLElement) {
		...
		this.addEventListener('removed', function () {
			this.traverse(function (object) {
				if (object.element instanceof HTMLElement && object.element.parentNode !== null) {
...
class CSS2DRenderer {
	...
	constructor() {
		...
		function renderObject(object: any, scene: Scene, camera: Camera) {
